export default angular.module('mgrsConverter', []).factory('mgrsConverter', MGRS);
function MGRS() {
  /**
  ...
  return {
    geographicToMgrs: geographicToMgrs,
    mgrsToGeographic: mgrsToGeographic,
    toPoint: toPoint
  };
   ...
   */
  function geographicToMgrs(ll, accuracy) {
   ...
   */
  function mgrsToGeographic(mgrs) {
  ...
  function LLtoUTM(ll) {
    ...
    let UTMEasting = (k0 * N * (A + (1 - T + C) * A * A * A / 6.0 + (5 - 18 * T + T * T + 72 * C - 58 * eccPrimeSquared) * A * A * A * A * A / 120.0) + 500000.0);
  ...
  function encode(utm, accuracy) {
    ...
    let seasting = "00000" + utm.easting,
  ...
  function get100kID(easting, northing, zoneNumber) {
    let setParm = get100kSetForZone(zoneNumber),
  ...
  function getLetter100kID(column, row, parm) {
    ...
    let twoLetter = String.fromCharCode(colInt) + String.fromCharCode(rowInt);
    return twoLetter;
  }
